...
##### The purpose of Urbanism 3.0 is to create new forms of urbanism generated by open source decentralised  applications that run as immutable code on a platform that provides strong guaranties about the future execution of the protocol.<br><br>
